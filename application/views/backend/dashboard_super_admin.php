                ...
                <form class="form form_add">
                    <div class="card-body">
                        <div class="form-group">
                            <label>Lokasi<span style="color:red;">*</span></label><br>
                            <select class="form-control pasien_lokasi" id="pasien_lokasi" style="width: 100%;">
                                <option value="">Pilih Lokasi</option>
                                <?php foreach ($tempat as $val) { ?>
                                    <option value="<?php echo $val->lokasi_id ?>"><?php echo $val->lokasi_nama ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-body">
                <form class="form form_detil">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Lokasi<span style="color:red;">*</span></label><br>
                            <select class="form-control pasien_lokasi_detil" id="pasien_lokasi_detil" style="width: 100%;">
                                <option value="">Pilih Lokasi</option>
                                <?php foreach ($tempat as $val) { ?>
                                    <option value="<?php echo $val->lokasi_id ?>"><?php echo $val->lokasi_nama ?></option>
                                <?php } ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form form_status">
                    <div class="card-body">
                        <div class="form-group">
                            <label>Lokasi Pasien<span style="color:red;">*</span></label><br>
                            <select style="width:100%" class="form-control lokasi_pasien_export" id="lokasi_pasien_export">
                        ...
                        <div class="form-group ">
                            ...
                            <select style="width:100%" class="form-control status_pasien_export" id="status_pasien_export">
...
<script>
    ...
    $('.pasien_lokasi').select2();

    $('.pasien_lokasi_detil').select2();
    $('.lokasi_pasien_export').select2();
    $('.status_pasien_export').select2();
    ...
    $('.btnTambah').click(function() {
        ...
        $('.pasien_lokasi').val("").trigger("change");
    ...
    $('.btnExport').click(function() {
        ...
        $('.lokasi_pasien_export').val("").trigger("change");
        $('.status_pasien_export').val("").trigger("change");
    ...
    $('.btnExportSubmit').click(function() {
        Jhxlsx.export([{
            "sheetName": "Sheet1",
            "data": objects[$('.lokasi_pasien_export').val() - 1][$('.status_pasien_export').val()]
        }], {
            fileName: $('.lokasi_pasien_export option:selected').text() +" ("+$('.status_pasien_export option:selected').text()+ ") "+ moment().format('DD-MM-YYYY')
        });
    })

    $('.btnSubmitDetil').click(function() {
        if ($('.pasien_lokasi_detil').val() == '' || $('.pasien_nik_detil').val() == '' || $('.pasien_nama_detil').val() == '' || $('.pasien_jk_detil').val() == '' || $('.pasien_tempat_lahir_detil').val() == '' || $('.pasien_tgl_lahir_detil').val() == '' ||
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url('dashboard/update_pasien_super') ?>',
                dataType: 'json',
                data: {
                    pasien_id: $('.pasien_id_detil').val(),
                    pasien_nik: $('.pasien_nik_detil').val(),
                    pasien_lokasi_id: $('.pasien_lokasi_detil').val(),
    ...
    $('.btnSave').click(function() {
        ...
        if ($('.pasien_lokasi').val() == '' || $('.pasien_nik').val() == '' || $('.pasien_nama').val() == '' || $('.pasien_jk').val() == '' || $('.pasien_tempat_lahir').val() == '' || $('.pasien_tgl_lahir').val() == '' ||
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url('dashboard/add_pasien_super') ?>',
                dataType: 'json',
                data: {
                    pasien_nik: $('.pasien_nik').val(),
                    pasien_lokasi_id: $('.pasien_lokasi').val(),
                            ...
                            bootbox.confirm({
                                ...
                                callback: function(result) {
                                    if (result) {
                                        ...
                                        $.ajax({
                                            type: 'POST',
                                            url: '<?php echo base_url('dashboard/add_pasien2_super') ?>',
                                            dataType: 'json',
                                            data: {
                                                pasien_nik: $('.pasien_nik').val(),
                                                pasien_lokasi_id: $('.pasien_lokasi').val(),
        ...
        var demo = function() {
            ...
            var datatable = $('#kt_datatable').KTDatatable({
                ...
                data: {
                    ...
                    source: {
                        read: {
                            url: '<?php echo base_url('dashboard/list_pasien_superadmin') ?>',
                            map: function(raw) {
                                // sample data mapping
                                var dataSet = raw;
                                ...
                                for (var i = 0; i < dataSet.length; i++) {
                                    ...
                                    objects[dataSet[i].pasien_lokasi_id - 1][dataSet[i].pasien_status].push(
                                        [{
								...
								<a href="javascript:;" class="btn btn-sm btn-clean btn-icon" data-toggle="dropdown">\
							  	...
							  	<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">\
									<ul class="nav nav-hoverable flex-column">\
							    		<li class="nav-item"><a data-id="' + row.pasien_id + '" data-nik="' + row.pasien_nik + '" class="nav-link btnDetail" href="#"><i class="nav-icon la la-eye"></i><span class="nav-text">Details</span></a></li>\
							    		<li class="nav-item"><a data-id="' + row.pasien_id + '" data-nik="' + row.pasien_nik + '" class="nav-link btnEdit" href="#"><i class="nav-icon la la-edit"></i><span class="nav-text">Edit</span></a></li>\
                                        <li class="nav-item"><a data-id="' + row.pasien_id + '" data-nik="' + row.pasien_nik + '" data-lokasi="' + row.pasien_lokasi_id + '" class="nav-link btnPindah" href="#"><i class="nav-icon la la-home"></i><span class="nav-text">Pindah Karantina</span></a></li>\
                                        <li class="nav-item"><a data-id="' + row.pasien_id + '" data-nik="' + row.pasien_nik + '" class="nav-link btnSelesai" href="#"><i class="nav-icon la la-check"></i><span class="nav-text">Selesai</span></a></li>\
									</ul>\
							  	</div>\
							</div>\
							<a href="javascript:;" data-id="' + row.pasien_id + '" data-nik="' + row.pasien_nik + '" class="btn btn-sm btn-clean btn-icon btnDelete" title="Delete">\
            ...
            $('#kt_datatable_search_lokasi').on('change', function() {
                datatable.search($(this).val().toLowerCase(), 'pasien_lokasi_id');
            });

            $('#kt_datatable_search_lokasi').select2();
            // $('#kt_datatable_search_lokasi').val(1).trigger("change");
            ...
            $(document).on("click", ".btnDetail", function() {
                ...
                $('.pasien_lokasi_detil').attr('disabled', true);
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('.pasien_lokasi_detil').val(data.pasien_lokasi_id).trigger("change");
            ...
            $(document).on("click", ".btnEdit", function() {
                ...
                $('.pasien_lokasi_detil').attr('disabled', false);
